...
//		1. Launch browser
		...
		System.setProperty("Webdriver.chhrome.driver","C:\\Users\\User\\Downloads\\chrome-win32\\chrome-win32\\Chrome.exe");
...
//		6. Enter incorrect email address and password
		...
		driver.findElement(By.xpath("//*[@id=\"form\"]/div/div/div[1]/div/form/input[2]")).sendKeys("jbj@jjkn");
		driver.findElement(By.xpath("//*[@id=\"form\"]/div/div/div[1]/div/form/input[3]")).sendKeys("hb");
		Thread.sleep(2000);
...
//		8. Verify error 'Your email or password is incorrect!' is visible
		...
		if(errorMsg.equals(actualerrormsg)==true) {
